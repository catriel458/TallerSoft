...
import { insertTurnoSchema, type Turno } from "@/lib/schema";
...
export default function TurnosPage() {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: z.infer<typeof insertTurnoSchema>) => {
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: z.infer<typeof insertTurnoSchema> }) => {
